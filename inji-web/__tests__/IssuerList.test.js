...
import IssuerList from '../src/components/Issuers/IssuerList';
import {SampleIssuersData} from '../src/__mocks__/testData';
...
describe('Testing issuer list component', () => {
    test('Check rendering', () => {
        ...
        expect(
            screen.getByText('Download Sunbird Credentials'),
        ).toBeInTheDocument();
    });
});
