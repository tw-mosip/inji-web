...
const ErrorComponent = () => {
    return (
        <ErrorIcon
            style={{fontSize: '40px', color: 'red', margin: '12px auto'}}
        />
    );
};
...
const SuccessComponent = () => {
    return (
        <DoneIcon
            style={{fontSize: '40px', color: 'green', margin: '12px auto'}}
        />
    );
};
            ...
            return (
                <Modal open={inProgress}>
                    <Grid
                        ...
                        <Grid item xs={12}>
                            <CircularProgress
                                style={{fontSize: '24px', margin: '12px auto'}}
                            />
                        </Grid>
                        <Grid item xs={12}>
                            <TextWrapper
        ...
        case 'Download complete':
            return (
                <>
                    ...
                    <Grid item xs={12}>
                        <TextWrapper variant="h6" style={{margin: '12px auto'}}>
                            {message}
                        </TextWrapper>
                    </Grid>
                    <Grid item xs={12}>
