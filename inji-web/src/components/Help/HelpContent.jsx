...
const data = [
    {
        ...
        panelContents: [
            'Issuers are either governmental bodies or entities trusted by the government, responsible for providing verifiable credentials in PDF format to residents upon request.',
        ],
    },
    {
        panelId: 'panel2',
    ...
    },
    {
        ...
        panelContents: [
            'The verifiable credential will be downloaded into the Downloads folder of your system.',
        ],
    },
    {
        panelId: 'panel6',
        ...
        panelContents: [
            'Details collected as part of the registration process will be presented in the PDF. At present, for Insurance use case, one can find Policy details like Name, DoB, ',
        ],
    },
    {
        panelId: 'panel7',
        ...
        panelContents: [
            "We’re sorry you stumbled upon an error. However, please check if the issuers' end point is available. If the end point health check is good, please check if the issuers list is configured in the mimoto-issuers config.json.",
        ],
    },
];
