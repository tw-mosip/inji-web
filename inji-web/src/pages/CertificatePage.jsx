...
function Certificate(props) {
    ...
    useEffect(() => {
        ...
        fetchAccessToken(issuerId, code, clientId, codeVerifier)
            .then(response => {
                ...
                downloadCredentials(issuerId, certificateId, token)
                    ...
                    .catch(error => {
                        console.error(
                            'Error occurred while downloading the credential. Error message: ',
                            error,
                        );
    ...
    return (
        <PageTemplate>
            <Header />
            <Box
                style={{minHeight: '100vh', width: '90%', margin: '40px auto'}}>
                <Grid
                    container
                    style={{
                        display: 'grid',
